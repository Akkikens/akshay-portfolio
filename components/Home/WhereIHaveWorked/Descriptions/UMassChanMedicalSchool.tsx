      ...
      <div className="flex flex-col space-y-8">
        <div className="flex flex-col space-y-2">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center space-y-1 sm:space-y-0 sm:space-x-3">
            <span className="text-AAsecondary font-semibold text-base sm:text-lg">@ UMass Chan Medical School</span>
            <span className="hidden sm:block w-1.5 h-1.5 bg-AAaccent rounded-full"></span>
            <span className="font-mono text-xs sm:text-sm text-AAsubtext">May 2024 - January 2025</span>
          </div>
        </div>
